...
const Navigation: React.FC<Props> = ({ onFilterWebinars, onTagFilterWebinars, webinarData, tagFilteredWebinars }) => {
  ...
  const handleButtonClick = (buttonType: string) => {
    ...
    setIsReplayClicked(buttonType === "Replays webinaires");
    ...
    <nav className="navigation">
      <div className="navigation__left">
        <ul>
          ...
          <li>
          <FilterButton
            buttonType="Replays webinaires"
            activeButton={activeButton}
            onClick={() => handleButtonClick("Replays webinaires")}
          />  
          </li>
          <li>
          <FilterButton
      ...
      <div className="navigation__right">
        <ul>
          ...
          <li className="navigation__dropdowncheckbox" style={{display:'none'}}>
